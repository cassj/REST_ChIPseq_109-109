...
colnms <- qw(space, start, end, width, names, peak, strand, feature, start_position, end_position, insideFeature,distancetoFeature, shortestDistance,fromOverlappingOrNearest,overlapping.exon, type, mgi_symbol, description , Length, nTags_ChIP, nTags_Cnt, neg10log10pVal, FoldEnrichment, FDR)
